...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#050505] text-white max-w-md mx-auto relative overflow-hidden pb-32 border-x border-white/15 ring-1 ring-white/10 shadow-[0_0_50px_rgba(255,255,255,0.05)]">
      ...
      {/* Navigation Bar */}
      <nav aria-label="Primary navigation" className="fixed bottom-8 left-1/2 -translate-x-1/2 w-[90%] max-w-[360px] bg-black/40 backdrop-blur-3xl border border-white/10 rounded-full py-4.5 px-8 z-50 flex justify-between items-center shadow-2xl ring-1 ring-white/5">
        <NavItem 
        ...
        />
        <NavItem 
          ariaLabel="My Office Gamification"
        ...
        />
        <NavItem 
          ariaLabel="Information and Governance"
...
const NavItem = ({ icon, active, onClick, ariaLabel }: { icon: React.ReactNode, active: boolean, onClick: () => void, ariaLabel: string }) => (
  <button 
    ...
    className={`p-2 transition-all duration-500 relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0088cc] focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded-full ${active ? 'text-[#0088cc] scale-125' : 'text-gray-600 hover:text-gray-400'}`}
  >
    {icon}
    {active && (
