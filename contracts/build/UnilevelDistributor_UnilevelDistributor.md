...
### SetUpline
TL-B: `set_upline#1432e0b5 user:address upline:address = SetUpline`
Signature: `SetUpline{user:address,upline:address}`
...
### UnilevelDistributor$Data
TL-B: `_ owner:address vora_jetton_wallet:address uplines:dict<address, address> = UnilevelDistributor`
Signature: `UnilevelDistributor{owner:address,vora_jetton_wallet:address,uplines:dict<address, address>}`
...
graph TD
UnilevelDistributor
UnilevelDistributor --> BaseTrait
UnilevelDistributor --> Deployable
