...
async function Escrow_init(owner: Address, treasuryAddress: Address, voraTokenAddress: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initEscrow_init_args({ $$type: 'Escrow_init_args', owner, treasuryAddress, voraTokenAddress })(builder);
...
const Escrow_receivers: ABIReceiver[] = [
    ...
    {"receiver":"internal","message":{"kind":"typed","type":"ReleaseTrade"}},
    {"receiver":"internal","message":{"kind":"typed","type":"CancelTrade"}},
...
export class Escrow implements Contract {
    ...
    static async init(owner: Address, treasuryAddress: Address, voraTokenAddress: Address) {
        return await Escrow_init(owner, treasuryAddress, voraTokenAddress);
    }
    
    static async fromInit(owner: Address, treasuryAddress: Address, voraTokenAddress: Address) {
        const __gen_init = await Escrow_init(owner, treasuryAddress, voraTokenAddress);
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: CreateTrade | ReleaseTrade | CancelTrade | Deploy) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'ReleaseTrade') {
            body = beginCell().store(storeReleaseTrade(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'CancelTrade') {
            body = beginCell().store(storeCancelTrade(message)).endCell();
        }
