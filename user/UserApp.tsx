...
const NavItem: React.FC<{ icon: React.ReactNode; active: boolean; onClick: () => void; ariaLabel?: string }> = ({ icon, active, onClick, ariaLabel }) => (
    <button
        ...
        className={`p-2 transition-all relative outline-none rounded-xl focus-visible:ring-2 focus-visible:ring-[#0088cc]/50 ${active ? 'scale-125 text-[#0088cc]' : 'text-gray-600'}`}
    >
...
import VoraLivePage from '../src/pages/VoraLivePage';
                    ...
                    <nav className="bg-black/60 backdrop-blur-3xl border border-white/10 rounded-[2rem] flex justify-between items-center px-4 py-3 shadow-2xl pointer-events-auto">
                        ...
                        <div className="relative -top-6">
                            <button
                                ...
                                className={`w-14 h-14 rounded-full bg-gradient-to-br border-4 border-[#050505] shadow-[0_4px_25px_rgba(220,38,38,0.5)] flex items-center justify-center transition-transform outline-none focus-visible:ring-2 focus-visible:ring-red-500/50 ${activeTab === NavTab.OFFICE
