...
const NavItem: React.FC<{ ariaLabel: string; icon: React.ReactNode; active: boolean; onClick: () => void }> = ({ ariaLabel, icon, active, onClick }) => (
    <button
        aria-label={ariaLabel}
        title={ariaLabel}
        onClick={onClick}
        className={`p-2 transition-all relative focus-visible:ring-2 focus-visible:ring-[#0088cc] focus-visible:outline-none rounded-lg ${active ? 'scale-125 text-[#0088cc]' : 'text-gray-600'}`}
    >
                    ...
                    <nav className="bg-black/60 backdrop-blur-3xl border border-white/10 rounded-[2rem] flex justify-between items-center px-4 py-3 shadow-2xl pointer-events-auto">
                        ...
                        <div className="relative -top-6">
                            <button
                                ...
                                className={`w-14 h-14 rounded-full bg-gradient-to-br border-4 border-[#050505] shadow-[0_4px_25px_rgba(220,38,38,0.5)] flex items-center justify-center transition-transform focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none ${activeTab === NavTab.OFFICE
