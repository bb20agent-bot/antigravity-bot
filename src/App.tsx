...
const NavItem = ({ ariaLabel, icon, active, onClick, className }: { ariaLabel: string, icon: React.ReactNode, active: boolean, onClick: () => void, className?: string }) => (
  <button aria-label={ariaLabel} title={ariaLabel} onClick={onClick} className={`p-2 transition-all relative focus-visible:ring-2 focus-visible:ring-[#0088cc] focus-visible:outline-none rounded-lg ${className || ''} ${active ? 'scale-125' : 'text-gray-600'}`}>
